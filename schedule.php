...
$schedules = $conn->query("SELECT schedules.*, users.nome, users.nome_de_pista, aeronaves.matricula, aeronaves.modelo FROM schedules JOIN users ON schedules.user_id = users.id JOIN aeronaves ON schedules.aircraft_id = aeronaves.id WHERE date = '$selected_date' ORDER BY date, start_time");
...
<body>
    ...
    <section class="schedule-container">
        ...
        <table class="user-schedule-table">
            ...
            <tbody>
                <?php
                $user_schedules = $conn->query("SELECT schedules.*, aeronaves.matricula, aeronaves.modelo FROM schedules JOIN aeronaves ON schedules.aircraft_id = aeronaves.id WHERE schedules.user_id = " . $_SESSION['user_id'] . " ORDER BY date, start_time");
